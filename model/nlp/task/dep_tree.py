...
#with open('/Users/sunqf/startup/quotesbot/nlp-data/chinese_segment/data/parser/ctb.ud.gold') as file, open('./invalid.tree', 'w') as bad_file:
with open('/Users/sunqf/startup/quotesbot/nlp-data/chinese_segment/conll/zh_conll/evsam05/data/THU/train.conll') as file, open('./invalid.tree.thu', 'w') as bad_file:
